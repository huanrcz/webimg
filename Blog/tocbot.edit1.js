        ...
        !function(n, o) {
            ...
            if ("undefined" != typeof window) {
                ...
                c.init = function(e) {
                    ...
                    c.destroy(),
                    null !== (d = i.selectHeadings(r.contentSelector, r.headingSelector)))) {
                        ...
                        this._scrollListener = o(function(e) {
                            ...
                            (e && (0 === e.eventPhase || null === e.currentTarget) || t) && (l.updateToc(d),
...
, function(e, t) {
    e.exports = function(e) {
        ...
        function l(t) {
            ...
            return t && (l += h + e.collapsibleClass,
            l += h + e.isCollapsedClass),
        ...
        function r(t) {
            return -1 !== t.className.indexOf(e.collapsibleClass) && -1 !== t.className.indexOf(e.isCollapsedClass) ? (t.className = t.className.split(h + e.isCollapsedClass).join(""),
            r(t.parentNode.parentNode)) : t
        }
        function c(t) {
...
, function(e, t) {
    e.exports = function(e) {
        ...
        function l(l, i) {
            for (var s = o(l), r = n(l), c = i, a = t(c), u = a ? a.headingLevel : 0, d = r - u; d > 0; )
                a = t(c),
...
, function(e, t) {
    ...
    function o(e, t) {
        ...
        var i, s, r = window.pageYOffset, c = {
            duration: t.duration,
            offset: t.offset || 0,
            callback: t.callback,
            easing: t.easing || l
        }, a = document.querySelector('[id="' + decodeURI(e).split("#").join("") + '"]'), u = "string" == typeof e ? c.offset + (e ? a && a.getBoundingClientRect().top || 0 : -(document.documentElement.scrollTop || document.body.scrollTop)) : e, d = "function" == typeof c.duration ? c.duration(u) : c.duration;
